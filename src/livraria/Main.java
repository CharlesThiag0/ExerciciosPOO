...
public class Main {
	...
	Biblioteca biblioteca1 = new Biblioteca(endereco1, cliente1, caixa1, "CyberPunk2077", 2077);
	...
	Biblioteca biblioteca2 = new Biblioteca(endereco2, cliente2, caixa2, "Percy jackson", 2005);
